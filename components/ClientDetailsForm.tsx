// ============================================
// ClientDetailsForm — Client info section on booking detail page
// Display-only with contact actions
// ============================================
    ...
    <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-100 text-sm font-semibold text-brand-700 dark:bg-brand-900/30 dark:text-brand-300">
            {client.name
              .split(" ")
              .map((n) => n[0])
              .join("")
