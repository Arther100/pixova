...
function LoginPageContent() {
  ...
  // ── Tab — locked to photographer until client launch ──
  const [loginType] = useState<"photographer" | "client">("photographer");
  void typeParam; // reserved for future client tab re-enable
    ...
    <main className="flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-gray-950">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mt-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          {/* Photographer OTP flow — Client tab hidden until client launch */}
