...
const PLANS = [
  {
    ...
    bookings: 10,
    storage: "20 GB",
    features: ["10 bookings/month", "20 GB storage", "Client portal", "Agreements"],
  },
  {
    slug: "PRO",
    name: "Pro",
    ...
    bookings: 30,
    storage: "100 GB",
    features: ["30 bookings/month", "100 GB storage", "Priority support", "Custom branding"],
    popular: true,
  },
  {
    slug: "STUDIO",
    ...
    bookings: null,
    storage: "500 GB",
    features: ["Unlimited bookings", "500 GB storage", "Multi-user", "White-label"],
  },
];
